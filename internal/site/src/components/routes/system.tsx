		...
		return (
			<>
				...
				<div className="grid xl:grid-cols-2 gap-4">
					...
					<TemperatureChart chartData={chartData} grid={grid} dataEmpty={dataEmpty} setPageBottomExtraMargin={setPageBottomExtraMargin} />
					<BatteryChart chartData={chartData} grid={grid} dataEmpty={dataEmpty} maxValues={maxValues} />
				</div>
				...
				{pageBottomExtraMargin > 0 && <div style={{ marginBottom: pageBottomExtraMargin }} />}
			</>
		)
	}
			...
			<Tabs value={activeTab} onValueChange={setActiveTab}>
				...
				{hasSystemd && (
					<TabsContent value="services" forceMount className={activeTab === "services" ? "contents" : "hidden"}>
						{mountedTabs.has("services") && <LazySystemdTable systemId={system.id} />}
					</TabsContent>
				)}
			</Tabs>
		)
